...
def main():
    # Ask the user to input a graph. The user inputs each element in
    # each row of the graph. The rows get strung together to create a
    # matrix.
    ...
    # Ask the user to specify the starting index of the matrix for the
    # NNA.
    start_vertex = int()
    ...
    # The NNA is called with the matrix and starting index created
    # earlier. The values are saved for printing to stdout.
    total_cost, used_vertices = nearest_neighbor_algorithm(graph, start_vertex)

    # Converts the indexes used by the NNA to string vertices using the
    # vertex string.
